...
![image-20211127171450889](/Users/vince/Library/Application Support/typora-user-images/image-20211127171450889.png)
...
![image-20211127173644445](/Users/vince/Library/Application Support/typora-user-images/image-20211127173644445.png)
...
- 不丢消息。“丢消息”是互动中让人难以接受的 Bug，某些场景下可能导致业务可用性差，甚至不可用的情况。
- 消息不重复。消息重复不仅会对用户造成不必要的骚扰和困惑，可能还会导致比较严重的业务异常。

#### 消息流转图

![image-20211127180417653](/Users/vince/Library/Application Support/typora-user-images/image-20211127180417653.png)
...
![image-20211127182319157](/Users/vince/Library/Application Support/typora-user-images/image-20211127182319157.png)
...
- 客户端主动拉取
  ...
  ![image-20211127184043916](/Users/vince/Library/Application Support/typora-user-images/image-20211127184043916.png)
...
​	对于点对点的聊天场景，时序一致性需要保证接收方的接收顺序和发送方的发出顺序一致；

​	而对于群组聊天，时序一致性保证的是群里所有接收人看到的消息展现顺序都一样。
...
​	找到一个核心的时序基准。可以是时间戳，也可以是序列号。前提是保证其有序。
...
​		![image-20211128135217635](/Users/vince/Library/Application Support/typora-user-images/image-20211128135217635.png)	

场景二：顺序一致性问题

​		![image-20211128135750364](/Users/vince/Library/Application Support/typora-user-images/image-20211128135750364.png)	
...
```
实现复杂，需要一定的学习成本；
Redis 本身是服务端单线程模型，Lua 脚本中尽量不要有远程访问和其他耗时的操作，以免长时间Hang住，导致整个资源不可用。
```
